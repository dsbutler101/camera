...
def GenerateConfig(ctx):
  ...
  cloud_function = {
      ...
      'properties': {
          ...
          'sourceArchiveUrl':
              source_archive_url,
          'environmentVariables': ctx.properties['environmentVariables'],
          'entryPoint':
              ctx.properties['entryPoint'],
          'eventTrigger': ctx.properties['eventTrigger'],
          'timeout':
      ...
      'metadata': {
          'dependsOn': ['build_step_' + function_name]
      }
  }
